...
def fuzzy_image_opening(image: numpy.ndarray,
    ...
    for _ in range(0, iterations):
        erosion = fuzzy_image_erosion(image=result,
                                      structuring_element=structuring_element,
                                      iterations=1,
                                      implication=erosion_implication)
        dilation = fuzzy_image_dilation(image=erosion,
